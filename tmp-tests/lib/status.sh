...
Health_Check() {
    ...
    # The /Users/tab/Downloads/Asus-Merlin-Zapret2-GUI/tmp-tests/proc/<pid>/cmdline is null separated. 
    local cmdline
    if [ -f "/Users/tab/Downloads/Asus-Merlin-Zapret2-GUI/tmp-tests/proc/$pid/cmdline" ]; then
        cmdline=$(tr '\0' ' ' < "/Users/tab/Downloads/Asus-Merlin-Zapret2-GUI/tmp-tests/proc/$pid/cmdline" 2>/dev/null)
